...
public interface IPropertyDataView : IMemberDataView, ISymbolInfoDataView
{
    ...
    object? GetIndexerValue(object? target, params object?[] indices);
    bool TryGetIndexerValue(object? target, out object? propertyValue, params object?[] indices);
    TValue GetIndexerValue<TTarget, TValue, TIndex>(TTarget target, params TIndex[] indices);
    bool TryGetIndexerValue<TTarget, TValue, TIndex>(TTarget target, out TValue propertyValue, params TIndex[] indices);
    TValue GetIndexerValue<TTarget, TValue>(TTarget target, params object?[] indices);
    bool TryGetIndexerValue<TTarget, TValue>(TTarget target, out TValue propertyValue, params object?[] indices);
    ...
    void SetIndexerValue(object? target, object? value, params object?[] indices);
    bool TrySetIndexerValue(object? target, object? value, params object?[] indices);
    void SetStructValue<TTarget, TValue>(ref TTarget target, TValue value, params object?[] indices) where TTarget : struct;
    bool TrySetStructValue<TTarget, TValue>(ref TTarget target, TValue value, params object?[] indices) where TTarget : struct;
    ...
    void SetStructIndexerValue<TTarget, TValue>(ref TTarget target, TValue value, params object?[] indices) where TTarget : struct;
    bool TrySetStructIndexerValue<TTarget, TValue>(ref TTarget target, TValue value, params object?[] indices) where TTarget : struct;
    void Set3DIndexerValue<TTarget, TValue, TIndex1, TIndex2, TIndex3>(TTarget? target, TValue value, TIndex1 index1, TIndex2 index2, TIndex3 index3) where TTarget : class?;
    bool TrySet3DIndexerValue<TTarget, TValue, TIndex1, TIndex2, TIndex3>(TTarget? target, TValue value, TIndex1 index1, TIndex2 index2, TIndex3 index3) where TTarget : class?;
    void Set2DIndexerValue<TTarget, TValue, TIndex1, TIndex2>(TTarget? target, TValue value, TIndex1 index1, TIndex2 index2) where TTarget : class?;
    bool TrySet2DIndexerValue<TTarget, TValue, TIndex1, TIndex2>(TTarget? target, TValue value, TIndex1 index1, TIndex2 index2) where TTarget : class?;
    void SetIndexerValue<TTarget, TValue, TIndex>(TTarget? target, TValue value, params TIndex[] indices) where TTarget : class?;
    bool TrySetIndexerValue<TTarget, TValue, TIndex>(TTarget? target, TValue value, params TIndex[] indices) where TTarget : class?;
