...
internal readonly struct WellKnownFieldDescriptor : IEquatable<WellKnownFieldDescriptor>
{
    ...
    public bool Equals(WellKnownFieldDescriptor other) => ReferenceEquals(FieldInfo, other.FieldInfo)
        && FieldHandle == other.FieldHandle
    ...
    public override int GetHashCode()
    {
        ...
        hashCode.Add(FieldInfo);
        hashCode.Add(FieldName, StringComparer.Ordinal);

        return hashCode.ToHashCode();
    }

    public static bool operator ==(WellKnownFieldDescriptor left, WellKnownFieldDescriptor right) => left.Equals(right);
    public static bool operator !=(WellKnownFieldDescriptor left, WellKnownFieldDescriptor right) => !(left == right);

    public override bool Equals(object obj) => obj is WellKnownFieldDescriptor other && Equals(other);
}
