namespace BionicCode.Controls.Net.Wpf
{
    ...
    public class TimePicker : ContentControl
    {
        ...
        public TimePicker()
        {
            ...
            {
                _ = timePattern.Append("hh");
            }

            _ = timePattern.Append(@"\:mm");
            if (this.IsSecondsEnabled)
            {
                _ = timePattern.Append(@"\:ss");
            }
        ...
        private static void OnTimeColumnVisibilityChanged(DependencyObject d, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            _ = this_.FormatTime(this_.SelectedTime);
        }
        ...
        protected virtual void OnIs24HourModeEnabledChanged(bool oldValue, bool newValue)
        {
            ...
            if (is24HourModeEnabled)
            {
                ...
                _ = CollectionViewSource.GetDefaultView(this.HoursSource).MoveCurrentToPosition(this.SelectedHours);
            }
            else
            {
                ...
                _ = CollectionViewSource.GetDefaultView(this.HoursSource).MoveCurrentToPosition(this.SelectedHours - 1);
            }
