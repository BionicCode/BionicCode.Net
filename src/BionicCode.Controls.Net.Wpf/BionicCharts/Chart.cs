namespace BionicCode.Controls.Net.Wpf
{
    ...
    public class ZoomFactorConverter : TypeConverter
    {
        ...
        public override bool CanConvertTo(ITypeDescriptorContext typeDescriptorContext, Type destinationType) => destinationType == typeof(string) || base.CanConvertTo(typeDescriptorContext, destinationType);
