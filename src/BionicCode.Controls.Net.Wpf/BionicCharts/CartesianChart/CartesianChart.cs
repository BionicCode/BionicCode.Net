...
<<<<<<< TODO: Unmerged change from project 'BionicCode.Controls.Net.Wpf(net9.0-windows)', Before:
<<<<<<< TODO: Unmerged change from project 'BionicCode.Controls.Net.Wpf(net9.0-windows)', Before:
        /* Unmerged change from project 'BionicCode.Controls.Net.Wpf (net6.0-windows)'
        Before:
...
>>>>>>> After
        ...
        */
        ...
        /// Sets
        /// </summary>
        public static new readonly DependencyProperty IsAutoScaleEnabledProperty = DependencyProperty.Register(
          "IsAutoScaleEnabled",
          typeof(bool),
          typeof(CartesianChart),
        ...
        /// </summary>
        public new bool IsAutoScaleEnabled
        {
        ...
        protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            if (element is not CartesianChartItem chartPointContainer)
            {
                return;
            }
