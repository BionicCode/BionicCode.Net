...
{
  /// <summary>
  /// Abstract implementation of <see cref="IFactory{TCreate}"/> that supports lifetime management using <see cref="Standard.FactoryMode"/>.
  /// </summary>
  ...
  {
    /// <summary>
    /// Initializes the <c>Factory</c> to create instances using <see cref="Standard.FactoryMode.Singleton"/>. 
    /// </summary>
    ...
    /// </summary>
    /// <param name="factoryMode">Describes the created objects lifetime using <see cref="Standard.FactoryMode"/>.</param>
