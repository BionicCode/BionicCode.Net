...
internal readonly struct WellKnownMethodDescriptor : IEquatable<WellKnownMethodDescriptor>
{
        ...
        Type? implementingType)
    {
        ...
        if (isExplicitInterfaceImplementation)
        {
            ...
            _implementingTypeHandle = implementingType.TypeHandle;
    ...
    public RuntimeTypeHandle ImplementingTypeHandle
        => IsExplicitInterfaceImplementation
            ? _implementingTypeHandle
            : throw new InvalidOperationException($"The property '{nameof(ImplementingTypeHandle)}' can only be accessed when the method is an explicit interface implementation (i.e. when the property '{nameof(IsExplicitInterfaceImplementation)}' is 'true').");
    ...
    public bool Equals(WellKnownMethodDescriptor other)
        ...
        && _implementingTypeHandle.Equals(other._implementingTypeHandle);
