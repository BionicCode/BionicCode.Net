namespace BionicCode.Utilities.Net.UnitTest.ExtensionMethodsTests
{
    ...
    public class ReflectionExtensionMethodsTestToUnqualifiedSignatureName
    {
        ...
        [Fact]
        public void ToSignatureName_TestEnum_MustReturnFullEnumSignature() => _ = typeof(TestEnum).ToSignatureName().Should().Be(TestEnumSignatureName);
    ...
    public class ReflectionExtensionMethodsTestToQualifiedSignatureName
    {
        ...
        [Fact]
        public void ToSignatureName_DelegateWithReturnValue_MustReturnFullDelegateSignature() => _ = typeof(TestDelegateWithReturnValue).ToSignatureName().Should().Be(TestDelegateWithReturnValueSignatureName);
