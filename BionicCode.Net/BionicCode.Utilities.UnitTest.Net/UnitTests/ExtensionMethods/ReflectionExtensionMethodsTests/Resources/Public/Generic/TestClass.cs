namespace BionicCode.Utilities.Net.UnitTest.ReflectionExtensionMethodsTests.Resources.Public.Generic
{
      ...
      where V : new()
    {
        ...
        public int PublicMethodWithReturnValue(string parameter) => 0;

        public U PublicGenericMethodWithReturnValue(T parameter) => default;

        public async Task<U> PublicGenericAsyncMethodWithReturnValue(T parameter) => await Task.FromResult<U>(default);
    }
}
