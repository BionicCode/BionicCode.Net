namespace BionicCode.Utilities.Net.UnitTest
{
    ...
    public class FactoryTest : IDisposable
    {
        ...
        public FactoryTest() => this.PersonFactory = new PersonFactory();

        [Fact]
        public void DefaultFactoryModeIsSingleton() => this.PersonFactory.FactoryMode.Should().Be(FactoryMode.Singleton);
        ...
        public void EnteringFactoryScopeMustSetFactoryModeToScoped()
        {
            ...
            _ = this.PersonFactory.FactoryMode.Should().Be(FactoryMode.Scoped);
        }
        ...
        public void LeavingFactoryScopeMustRevertFactoryModeFromScopedToPrevious()
        {
            ...
            _ = this.PersonFactory.FactoryMode.Should().Be(FactoryMode.Transient);
        }
        ...
        public void CallToParameterlessCreateProducesDefaultPerson()
        {
            ...
            _ = this.PersonFactory.Create().Should().BeEquivalentTo(referencePerson);
        }
        ...
        {
            Person referencePerson = CreateReferenceDefaultPerson();
            _ = this.PersonFactory.Create(this.PersonFirstName, this.PersonLastName, this.PersonId).Should().NotBeEquivalentTo(referencePerson);
        }
        ...
        public void CallToParameterizedCreateProducesNonDefaultPerson()
        {
            ...
            _ = this.PersonFactory.Create(this.PersonFirstName, this.PersonLastName, this.PersonId).Should().BeEquivalentTo(referencePerson);
        }
