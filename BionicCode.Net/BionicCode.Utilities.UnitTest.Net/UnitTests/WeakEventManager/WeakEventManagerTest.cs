namespace BionicCode.Utilities.Net.UnitTest.WeakEventManagerTests
{
  ...
  public class WeakEventManagerTest : IDisposable
  {
    ...
    public void RegisterAllEventHandlersEventSource1()
    {
      ...
      WeakEventManager<TestEventSource1>.AddEventHandler(this.EventSource1, nameof(TestEventSource1.CustomSignatureTwoParametersTestEvent), OnCustomSignatureTwoParametersTestEvent);
    ...
    public void RegisterAllEventHandlersEventSource2()
    {
      ...
      WeakEventManager<TestEventSource2>.AddEventHandler(this.EventSource2, nameof(TestEventSource2.CustomSignatureTwoParametersTestEvent), OnCustomSignatureTwoParametersTestEvent);
