...
namespace BionicCode.Utilities.Net.Framework.Dialog
{
  ...
  public interface IDialogViewModel : IViewModel
  {
    ...
    /// <summary>
    /// The <see cref="Framework.Dialog.DialogResult"/> of the user interaction.
    /// </summary>
    ...
    /// <summary>
    /// ICommand that can be bound to the buttons of the dialog. The command parameter is a <see cref="Framework.Dialog.DialogResult"/>.
    /// </summary>
