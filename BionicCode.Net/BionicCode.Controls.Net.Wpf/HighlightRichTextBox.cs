...
namespace BionicCode.Controls.Net.Wpf
{
    ...
    /// </summary>
    public readonly struct DelimiterPair : IEquatable<DelimiterPair>
    {
    ...
    /// </summary>
    public readonly struct HighlightArgs : IEquatable<HighlightArgs>
    {
    ...
    public readonly struct MatchInfo : IEquatable<MatchInfo>
    {
        ...
        private bool TryFindMatch(string input, int changeOffset, out List<MatchInfo> matchInfos)
        {
            ...
            foreach (DelimiterPair delimiterPair in this.DelimiterPairs)
            {
                ...
                if (this.StartMatchOffsets.TryGetValue(delimiterPair.Start, out int delimiterStartMatchIndex))
                {
                    ...
                    _ = this.StartMatchOffsets.Remove(delimiterPair.Start);
                    continue;
                }
