namespace BionicCode.Utilities.Net
{
  ...
  internal class ChartTableRow
    {
      internal protected static ChartTableRow NewRow(int cellCount) => new ChartTableRow(cellCount);
      internal protected static ChartTableRow NewRow(int cellCount, params object[] cellValues) => new ChartTableRow(cellCount, cellValues);
