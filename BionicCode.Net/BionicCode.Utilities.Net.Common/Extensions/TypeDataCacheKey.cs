namespace BionicCode.Utilities.Net
{
  ...
  internal readonly struct TypeDataCacheKey : ISymbolInfoDataCacheKey, ISymbolInfoDataCacheKey<RuntimeTypeHandle>, IEquatable<TypeDataCacheKey>
  {
    public TypeDataCacheKey(string symbolName, string symbolNamespace, RuntimeTypeHandle declaringTypeHandle, RuntimeTypeHandle symbolHandle, params object[] arguments)
    {
    ...
    public RuntimeTypeHandle SymbolHandle { get; }

    public bool Equals(TypeDataCacheKey other) => other.Name.Equals(this.Name, StringComparison.Ordinal)
    ...
    bool IEquatable<ISymbolInfoDataCacheKey<RuntimeTypeHandle>>.Equals(ISymbolInfoDataCacheKey<RuntimeTypeHandle> other)
      => other is TypeDataCacheKey cacheKey && Equals(cacheKey);
