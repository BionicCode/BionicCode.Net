namespace BionicCode.Utilities.Net
{
    ...
    public readonly struct Minute : IEquatable<Minute>, IComparable<Minute>, IComparable, IConvertible, ITimeUnit
    {
        ...
        public bool Equals(Minute other) => Value.Equals(other.Value);
    ...
    public override int GetHashCode()
    {
      ...
      return hashCode;
        ...
        public static Minute Add(Minute left, Minute right) => throw new NotImplementedException();

        public static Minute Subtract(Minute left, Minute right) => throw new NotImplementedException();

        public static Minute Multiply(Minute left, Minute right) => throw new NotImplementedException();

        public static Minute Divide(Minute left, Minute right)
        {
            throw new NotImplementedException();
        }
