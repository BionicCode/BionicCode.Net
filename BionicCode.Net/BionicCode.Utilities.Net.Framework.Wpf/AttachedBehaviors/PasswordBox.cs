...
namespace BionicCode.Utilities.Net.Framework.Wpf.AttachedBehaviors
{
  /// <summary>
  ...
  /// </summary>
  /// <remarks>The attached behavior does at no point unwrap the the <see cref="SecureString"/> returned from the <see cref="System.Windows.Controls.PasswordBox.SecurePassword"/> property, nor does it access the security critical <see cref="System.Windows.Controls.PasswordBox.Password"/> property. The <see cref="System.Windows.Controls.PasswordBox.SecurePassword"/> value is simply forwarded to the command target of the registerd <see cref="CommandProperty"/> attached property.</remarks>
