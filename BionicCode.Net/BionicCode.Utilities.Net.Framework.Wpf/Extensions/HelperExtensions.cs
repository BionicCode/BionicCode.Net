...
namespace BionicCode.Utilities.Net.Framework.Wpf.Extensions
{
  ...
  public static class HelperExtensions
  {
    ...
    /// <param name="ancestorLevel">The ancestor level. The number of encountered elements on the upward path starting at the current element  Use 1 to indicate the one nearest to the current element.</param>
    /// <returns>The parent element of matching type.</returns>
    public static bool TryFindVisualParentElement<TParent>(this DependencyObject child, out TParent resultElement, int ancestorLevel = 1)
    ...
    /// <param name="resultElement"></param>
    /// <returns>The parent element of matching name.</returns>
    ...
    /// <param name="resultElement"></param>
    /// <returns>The child element of matching type.</returns>
    ...
    /// <param name="parent"></param>
    /// <returns>An enumerable collection of encountered matches.</returns>
