...
//    /// <summary>
//    /// Attached property to serve as alternative text property for the <see cref="RichTextBox"/> (instead of using <see cref="Document"/>). Optional property to use with <see cref="TextBlock"/> (instead of <see cref="TextBlock.Text"/>). The defined <see cref="HighlightRange"/> items contained in the attached property <see cref="HighlightRangesProperty"/> collection will always be applied to <see cref="TextBlock.Text"/> and the <see cref="TextProperty"/> values. 
//    /// </summary>
//    /// <remarks>In case of the <see cref="TextProperty"/> being attached to a <see cref="RichTextBox"/>, the string value will be converted to a <see cref="FlowDocument"/> and assigned to the <see cref="Document"/> property.</remarks>
...
//    {
//      var textBox = sender as Windows.UI.Xaml.Controls.RichTextBox;
